    ...
    <header className="relative w-full px-5 lg:px-16 bg-[#203F51]">
      <div className={`h-[72px] grid grid-cols-3 items-center`}>
        ...
        <div className="col-span-1">
          <nav className="hidden lg:flex lg:space-x-5">
            <a href="/" className="item-a">
              <span className="ff-roboto text-white">Home</span>
            </a>
            <a href="#home-products">
              <span className="ff-roboto text-white">Productos</span>
            </a>
            <a href="#home-about-us">
              <span className="ff-roboto text-white">Sobre Nosotros</span>
            </a>
            <a href="#home-contact">
              <span className="ff-roboto text-white">Contacto</span>
            </a>
          </nav>
        ...
        <div className="col-span-1 flex justify-end">
          <a href="/login-form">
            <div className="w-[95px] h-[40px] rounded-[5px] bg-white text-[#203F51] font-bold text-sm flex justify-center items-center">
              LOGIN
            </div>
          </a>
        </div>

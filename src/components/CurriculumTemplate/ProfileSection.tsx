                ...
                <div className="flex justify-center space-x-3">
                    <a href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer">
                        <span className="socialbtn text-[#1773EA]">
                            ...
                            </svg></span></a><a href="https://twitter.com/" target="_blank" rel="noopener noreferrer">
                        ...
                        </span></a><a href="https://dribbble.com/" target="_blank" rel="noopener noreferrer">
                        <span className="socialbtn text-[#e14a84]">
                            ...
                            </svg></span></a><a href="https://www.linkedin.com/" target="_blank" rel="noopener noreferrer">
                ...
                <div className="p-7 rounded-2xl mt-7 bg-[#F3F6F6] dark:bg-[#1D1D1D]">
                    <div className="flex py-2.5 border-b border-[#E3E3E3] dark:border-[#3D3A3A]">
                        ...
                        <div className="text-left ml-2.5">
                            <p className="text-xs text-[#44566C] dark:text-[#A6A6A6]">Teléfono</p>
                    ...
                    <div className="flex py-2.5 border-b border-[#E3E3E3] dark:border-[#3D3A3A]">
                        ...
                        <div className="text-left ml-2.5">
                            ...
                            <p className="dark:text-white break-all">{user.locality + ", " + user.country}</p>
                        </div>
                    </div>
                    <div className="flex py-2.5 border-b border-[#E3E3E3] dark:border-[#3D3A3A]">
                        ...
                        <div className="text-left ml-2.5"><p className="text-xs text-[#44566C] dark:text-[#A6A6A6]">Email</p>
                            <p className="dark:text-white break-all">
                    ...
                    <div className="flex py-2.5 undefined">
                        ...
                        <div className="text-left ml-2.5"><p className="text-xs text-[#44566C] dark:text-[#A6A6A6]">Fecha de Nacimiento</p>
                            <p className="dark:text-white break-all">{user.birth}</p>
                        </div>
                    </div>
                </div>
                <div
                    onClick={()=>window.open(user.downloadFile)}

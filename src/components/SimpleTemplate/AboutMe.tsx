...
const AboutMe = ({ user }: Props) => {
    return (
        <div className="py-12" id='st-about-me'>
            <h2 className="after-effect after:left-52 mt-12 lg:mt-0 ">Sobre Mí</h2>
            <div className="grid grid-cols-12 md:gap-10 pt-4 md:pt-[40px]">
                <div className="col-span-12 md:col-span-4">
                    <img alt="routePath" src={user.histoyImg} width="300" height="400" decoding="async" data-nimg="1" className="w-full md:w-[330px] md:h-[400px] object-cover overflow-hidden rounded-[35px] mb-3 md:mb-0" loading="lazy" style={{ color: "transparent" }} />
                </div>
                <div className="col-span-12 md:col-span-8 space-y-2.5">
                    <div className=" md:mr-12 xl:mr-16">
                        <h3 className="text-4xl font-medium mb-2.5">¿Quien soy?</h3>
                    ...
                    <div>
                        <h3 className="text-4xl font-medium my-5 ">Información Personal</h3>
                        <div className=" grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div className="flex">
                                ...
                                <div className="space-y-1">
                                    <p className="text-xs text-gray-lite dark:text-color-910">Teléfono</p>
                            ...
                            <div className="flex">
                                ...
                                <div className="space-y-1">
                                    <p className="text-xs text-gray-lite dark:text-color-910">Ubicación</p>
                                    <h6 className="font-medium">{user.locality + ", " + user.country}</h6>
                                </div>
                            </div>
                            <div className="flex">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <h6 className="font-medium">
                                        <a className="hover:text-[#FA5252] duration-300 transition" href="mailto:ibthemes21@gmail.com">{user.email}</a>
                                    </h6>
                                </div>
                            </div>
                            <div className="flex">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <h6 className="font-medium">{user.birth}</h6>
                                </div>
                            </div>
                        </div>
                    </div>

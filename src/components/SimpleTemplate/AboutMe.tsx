                ...
                <div className="col-span-12 md:col-span-8 ">
                    ...
                    <div>
                        ...
                        <div className=" grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div className="flex">
                                <span className="text-color-50 shadow-icon mr-2.5 flex items-center justify-center rounded-md text-2xl w-12 text- cursor-pointer" onClick={() => saveContact(user)}>
                                ...
                                <div className="space-y-1 cursor-pointer" onClick={() => saveContact(user)}>

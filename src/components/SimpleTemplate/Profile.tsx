...
const Profile = ({ user }: Props) => {
    return (
        <div className="flex flex-col items-center h-[100vh] md:h-[90vh] lg:h-[80vh] xl:h-[71vh] justify-center aos-init aos-animate" data-aos="fade" id='st-profile'>
            <img
                alt="hero image"
                src={user.profileImg}
                width="250"
            ...
            <h3 className="mt-6 mb-1 text-5xl font-semibold">{user.firstName + " " + user.lastName}</h3>
            <p className="mb-4 text-[#7B7B7B]">{user.description}</p>
